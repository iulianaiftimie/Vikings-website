...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="textCenter"><h2 class="infotitle">Add Subject</h2></div>
        <div class="textCenter"><p class="infodetails">Title</p>
    ...
    <br />
    <asp:FileUpload ID="fuImage" runat="server" CssClass="txtBoxvaelg" />
    <br />
