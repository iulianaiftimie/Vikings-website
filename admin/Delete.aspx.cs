...
public partial class admin_Delete : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            litSubject.Text += "<div class='links'><a href='Delete.aspx?delid=" + sub["fldSubID"] + "' onclick='return confirm (\"Are you sure you want to delete this subject?\")'>" + sub["fldTitle"] + "</a><br /></div>";
        }
    }
